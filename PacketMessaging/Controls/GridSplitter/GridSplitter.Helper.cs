...
namespace PacketMessaging.Controls.GridSplitter
{
    ...
    public partial class GridSplitter
    {
        ...
        private bool SetColumnWidth(ColumnDefinition columnDefinition, double horizontalChange, GridUnitType unitType, int columnIndex)
        {
            ...
            if (newWidth > ActualWidth)
            {
				...
				// Update the listView column definitions for data column width
				_current.SetlistViewColumnDefinitionWidthAsync(columnIndex, columnDefinition.Width);

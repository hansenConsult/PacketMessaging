...
namespace FormControlBaseClass
{
    public class PrintHelper
    {
        ...
        public async Task ShowPrintUIAsync()
        {
            ...
            {
                var messageDialog = new MessageDialog("Error printing: " + e.Message);
                await messageDialog.ShowAsync();

                LogHelper.Log(LogLevel.Error, $"Error printing: " + e.Message + ", hr=" + e.HResult);
            }
        }
        ...
        public virtual void PreparePrintContent(FormControlBase page)
        {
            ...
            {
                firstPage = page;
                header = (StackPanel)firstPage.FindName("PrintableArea");
